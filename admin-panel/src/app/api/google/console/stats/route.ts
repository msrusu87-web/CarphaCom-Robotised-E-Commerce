  ...
  try {
    ...
    if (errorMsg.includes('has not been used in project') || errorMsg.includes('is disabled')) {
      return NextResponse.json({
        ...
        message: 'Google Search Console API is not enabled. Enable it from Google Cloud Console.',
        enableUrl: 'https://console.developers.google.com/apis/api/searchconsole.googleapis.com/overview?project=YOUR_GOOGLE_PROJECT_ID',
