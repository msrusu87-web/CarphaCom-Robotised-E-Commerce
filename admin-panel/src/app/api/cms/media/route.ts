...
const UPLOAD_DIR = '/var/www/carphacom/shared/static'
const PUBLIC_URL = 'https://www.YOUR_PNI_USERNAMEtrafic.ro/static'
const MEDUSA_STATIC = '/var/www/carphacom/current/medusa-backend/static'
