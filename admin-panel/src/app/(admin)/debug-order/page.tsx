      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">🔍 Debug Live - Order Monitoring</h1>
              <p className="text-gray-600 mt-1">Real-time log for all operations</p>
            </div>
          ...
          <div className="space-y-2 max-h-[600px] overflow-y-auto">
            {filteredLogs.length === 0 ? (
              <div className="text-center py-12 text-gray-500">
                <p>No logs {filter.search || filter.level !== 'all' || filter.source !== 'all' ? 'matching filters' : 'yet'}</p>
                <p className="text-sm mt-2">Create an order to see logs in real time</p>
              </div>
            ) : (
