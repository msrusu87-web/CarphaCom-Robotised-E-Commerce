...
const priceLists = [
  { id: 1, name: "VIP Prices", customers: 24, products: 156, discount: "15%", status: "active" },
  { id: 2, name: "Wholesale Prices", customers: 8, products: 156, discount: "25%", status: "active" },
  { id: 3, name: "Corporate Prices", customers: 12, products: 89, discount: "20%", status: "active" },
]
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500">Custom prices for customer groups</p>
        </div>
