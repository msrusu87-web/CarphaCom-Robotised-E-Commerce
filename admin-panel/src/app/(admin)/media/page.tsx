...
const folders = [
  { name: "Products", count: 156 },
  { name: "Banners", count: 24 },
  { name: "Blog", count: 45 },
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500">Manage images and media files</p>
        </div>
      ...
      {/* View Toggle */}
      <div className="flex items-center justify-between">
        <p className="text-sm text-gray-500">{mediaItems.length} files</p>
