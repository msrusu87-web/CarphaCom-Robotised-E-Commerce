...
const inventory = [
  { id: 1, product: "Men's Casual T-Shirt", sku: "TCB-001", location: "Warehouse A", stock: 45, reserved: 5, available: 40 },
  { id: 2, product: "Slim Fit Pants", sku: "PSF-002", location: "Warehouse A", stock: 32, reserved: 2, available: 30 },
  { id: 3, product: "Urban Sneakers", sku: "SU-003", location: "Warehouse B", stock: 18, reserved: 3, available: 15 },
  { id: 4, product: "Winter Jacket", sku: "GI-004", location: "Warehouse A", stock: 0, reserved: 0, available: 0 },
  { id: 5, product: "Elegant Watch", sku: "CE-005", location: "Warehouse B", stock: 12, reserved: 1, available: 11 },
]
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500">Monitor stock and locations</p>
        </div>
      </div>
