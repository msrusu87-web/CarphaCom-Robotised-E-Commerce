...
```bash
# Get sync status
curl -X GET "https://YOUR_PNI_USERNAMEtrafic.ro/admin/pni" \
  -H "Authorization: Bearer YOUR_TOKEN"

# Trigger full sync
curl -X POST "https://YOUR_PNI_USERNAMEtrafic.ro/admin/pni" \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
PNI_USERNAME=YOUR_PNI_USERNAME
PNI_PASSWORD=YOUR_PNI_PASSWORD
```
