...
export default async function syncPNIProducts(container: MedusaContainer) {
  // PNI SYNC DISABLED - keeping products but not syncing stock/price
  console.log("[PNI Sync Job] Sync is DISABLED. Skipping.");
  return;
...
// PNI SYNC DISABLED - Products kept, stock/price sync stopped
// To re-enable, remove the early return in the function body
export const config = {
  name: "sync-pni-products",
  schedule: "0 0 31 2 *", // Feb 31 = never runs (disabled)
};
