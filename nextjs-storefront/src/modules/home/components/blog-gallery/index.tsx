        ...
        <div className="grid grid-cols-1 xsmall:grid-cols-2 small:grid-cols-2 medium:grid-cols-4 gap-4">
          {posts.map((post) => (
            <LocalizedClientLink 
              ...
              className="group"
            >
              <article className="bg-dark-800 border border-dark-700 rounded-lg overflow-hidden hover:border-blue-500/50 transition-all duration-300 h-full">
                {/* Image */}
                ...
                {/* Content */}
                <div className="p-3">
                  <div className="text-dark-400 text-[10px] mb-1">
