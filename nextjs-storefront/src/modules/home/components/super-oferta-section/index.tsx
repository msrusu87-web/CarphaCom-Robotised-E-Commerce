          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-red-400 text-sm">Special discounts today only!</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 small:grid-cols-3 medium:grid-cols-4 gap-4">
          {products.slice(0, 4).map((product) => (
            <div key={product.id} className="relative overflow-hidden">
              {/* Super Oferta badge */}
              <div className="absolute top-1 right-1 z-10 bg-red-600 text-white text-xs font-bold px-2 py-1 rounded-full animate-bounce">
                SPECIAL OFFER
              </div>
