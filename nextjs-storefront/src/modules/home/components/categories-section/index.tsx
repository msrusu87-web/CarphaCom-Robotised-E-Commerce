        ...
        <div className="grid grid-cols-2 small:grid-cols-3 medium:grid-cols-6 gap-3">
          {CATEGORIES.map((category) => (
            <LocalizedClientLink
              ...
              className="group"
            >
              <div className={`bg-gradient-to-br ${category.color} border border-dark-700 rounded-xl overflow-hidden hover:border-primary-500/50 transition-all duration-300 hover:-translate-y-1`}>
                {/* Product Image */}
