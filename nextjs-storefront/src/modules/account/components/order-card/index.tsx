  ...
  return (
    <div className="bg-dark-700/50 rounded-xl p-4 flex flex-col" data-testid="order-card">
      ...
      {order.metadata?.awb_number && (
        <div className="mt-2 px-3 py-2 bg-green-500/10 border border-green-500/30 rounded-lg">
          <div className="flex items-center gap-2">
            <svg className="w-4 h-4 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" />
            </svg>
            <span className="text-sm font-medium text-green-300">
              AWB: <span className="font-bold text-green-200">{order.metadata.awb_number}</span>
            </span>
          </div>
          <p className="text-xs text-green-400 mt-1">Your package has been shipped and can be tracked</p>
        </div>
      )}
      ...
      <div className="grid grid-cols-2 small:grid-cols-4 gap-4 my-4">
        ...
        {numberOfProducts > 4 && (
          <div className="w-full h-full flex flex-col items-center justify-center">
            ...
            <span className="text-small-regular text-dark-300">more</span>
          </div>
        )}
      </div>
