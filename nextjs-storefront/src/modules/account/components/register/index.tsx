...
const Register = ({ setCurrentView }: Props) => {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-xl font-bold text-white mb-1">Create New Account</h1>
      ...
      <form className="w-full flex flex-col" action={formAction}>
        ...
        <SubmitButton className="w-full mt-4 h-11 bg-gradient-to-r from-accent-500 to-accent-600 hover:from-accent-600 hover:to-accent-700 active:scale-[0.98] text-white font-bold rounded-xl text-sm transition-all shadow-md" data-testid="register-button">
          Sign Up
        </SubmitButton>
      </form>
