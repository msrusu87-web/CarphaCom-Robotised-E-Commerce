  ...
  return (
    <div className="sticky top-0 inset-x-0 z-50 group">
      ...
      <div className="bg-dark-950 text-dark-200 py-2 text-sm hidden small:block">
        <div className="content-container flex justify-between items-center">
          <div className="flex items-center gap-4">
            <a href="tel:+40774077860" className="flex items-center gap-2 hover:text-primary-400 transition-colors" aria-label="Phone: +40 774 077 860">
              ...
              <span className="text-accent-400 font-semibold">+40 774 077 860</span>
            </a>
            <span className="text-dark-500" aria-hidden="true">|</span>
            <span>Fast delivery across Europe</span>
          </div>
          <div className="flex items-center gap-4">
            <a href="/warehouse/" target="_blank" className="flex items-center gap-1 text-accent-400 hover:text-accent-300 transition-colors">
      ...
      <header className="relative h-16 mx-auto border-b duration-200 bg-dark-900/95 backdrop-blur-md border-dark-700">
        <nav className="content-container flex items-center justify-between w-full h-full" aria-label="Main navigation">
          ...
          <div className="flex-1 basis-0 h-full flex items-center gap-2">
            ...
            <LocalizedClientLink
              className="hidden medium:flex items-center gap-1 text-dark-200 hover:text-primary-400 transition-colors duration-200 text-sm font-medium px-3"
              href="/store"
          ...
          <div className="flex items-center gap-x-3 h-full flex-1 basis-0 justify-end">
            ...
            <LocalizedClientLink
              className="hidden large:flex items-center gap-1 text-dark-200 hover:text-primary-400 transition-colors duration-200 text-sm font-medium"
              href="/blog"
            ...
            <div className="hidden small:flex items-center gap-x-3 h-full">
              ...
              >
                ...
                <span className="text-sm font-medium hidden medium:inline">Account</span>
              </LocalizedClientLink>
            </div>
            ...
            <Suspense
              fallback={
                <LocalizedClientLink
                  className="flex items-center gap-1.5 px-2.5 py-1.5 small:px-4 small:py-2 bg-primary-500 hover:bg-primary-600 text-white rounded-lg transition-colors duration-200 text-sm min-w-[44px] min-h-[44px] justify-center"
                  href="/cart"
