            ...
            <>
              <div className="relative flex h-full">
                <Popover.Button
                  ...
                  aria-label="Open navigation menu" className="relative h-full flex items-center gap-2 px-3 py-2 text-dark-300 hover:text-primary-400 transition-all ease-out duration-200 focus:outline-none min-w-[44px] min-h-[44px]"
                >
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-y-6">
                      ...
                      <Text className="flex justify-between txt-compact-small text-dark-500">
                        © {new Date().getFullYear()} CarphaCom · Qubit Page Limited
                      </Text>
                    </div>
                  </div>
                </PopoverPanel>
