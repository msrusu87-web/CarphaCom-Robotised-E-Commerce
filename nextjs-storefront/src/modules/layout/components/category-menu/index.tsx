              ...
              <div className="h-full flex flex-col">
                ...
                <div className="grid grid-cols-1 gap-3 flex-1">
                  ...
                  >
                    ...
                    <div>
                      <p className="text-white font-medium group-hover:text-primary-400 transition-colors">All Products</p>
                      <p className="text-xs text-dark-400">View entire store</p>
                    </div>
                  </LocalizedClientLink>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-white font-medium group-hover:text-accent-400 transition-colors">Categories</p>
                      <p className="text-xs text-dark-400">Browse by Category</p>
                    </div>
                  </LocalizedClientLink>
                </div>
