...
const ProductInfo = ({ product }: ProductInfoProps) => {
  ...
  const getConditionBadge = () => {
    ...
    const styles: Record<string, { bg: string; text: string; label: string }> = {
      'new': { bg: 'bg-green-500/20', text: 'text-green-400', label: '✨ New' },
      'refurbished': { bg: 'bg-yellow-500/20', text: 'text-yellow-400', label: '🔧 Refurbished' },
      'used': { bg: 'bg-orange-500/20', text: 'text-orange-400', label: '📦 Used' },
    }
