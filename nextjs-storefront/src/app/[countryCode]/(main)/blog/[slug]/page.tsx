...
export async function generateMetadata(props: PageProps): Promise<Metadata> {
  ...
  if (!post) {
    return {
      title: "Article not found | CarphaCom"
    }
  }
  
  return {
    title: post.seo_title || `${post.title} | CarphaCom`,
    description: post.seo_description || post.excerpt || `Read ${post.title} on the CarphaCom blog`,
    openGraph: {
      title: post.title,
            ...
            <div className="mt-8 p-6 bg-dark-800 border border-dark-700 rounded-xl">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-dark-400 text-sm">Admin</p>
                </div>
              </div>
            </div>
          </article>
          ...
          <aside className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-primary-500/20 to-primary-600/10 border border-primary-500/30 rounded-xl p-6">
              ...
              <p className="text-dark-300 text-sm mb-4">
                Contact us for personalised advice on choosing the right equipment.
              </p>
              <LocalizedClientLink
                href="/store"
