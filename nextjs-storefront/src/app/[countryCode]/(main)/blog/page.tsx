...
export const metadata: Metadata = {
  title: "Blog | CarphaCom",
  description: "Latest news, guides and reviews about CB, VHF, UHF and PMR radio communication equipment.",
}
    ...
    <div className="bg-dark-900 min-h-screen py-8">
      <div className="content-container">
        ...
        <div className="mb-8">
          ...
          <p className="text-dark-400">News, guides and reviews about radio communication equipment</p>
        </div>
        ...
        {posts.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">No articles</h3>
            <p className="text-dark-400">
              {category 
                ? "There are no articles in this category yet." 
                : "The blog has no published articles yet. Come back soon!"
              }
            </p>
          </div>
        )}
