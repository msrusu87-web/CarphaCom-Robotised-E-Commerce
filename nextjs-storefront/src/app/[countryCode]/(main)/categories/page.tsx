...
export const metadata: Metadata = {
  title: "Product Categories | CarphaCom",
  description: "Explore all product categories: CB radios, antennas, walkie talkies, accessories and more.",
}
  ...
  if (!categories || categories.length === 0) {
    return (
      <div className="min-h-[50vh] flex items-center justify-center bg-dark-900">
        <p className="text-dark-400">No categories available.</p>
      </div>
    )
  }
    ...
    <div className="bg-dark-900 min-h-screen">
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-dark-950 to-dark-900 py-16">
        ...
        <div className="relative content-container text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Product <span className="text-primary-400">Categories</span>
          </h1>
          <p className="text-xl text-dark-300 max-w-2xl mx-auto">
            Explore our complete range of professional communication equipment and accessories
          </p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-primary-900/50 via-dark-900 to-primary-900/50 py-16">
        <div className="content-container text-center">
          ...
          <p className="text-dark-300 mb-6">Contact us for personalised assistance</p>
