      ...
      try {
        ...
        const demoProducts: Product[] = [
          ...
          },
          {
            ...
            sku: 'PNI-MIC4PIN',
            rrp_price: 85,
            description: 'Professional CB microphone with 4-pin connection',
            stock_supplier: 150,
            box_size: 10,
            tiered_pricing: [
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-slate-300 text-lg">
            Products with dynamic quantity pricing. RRP (Recommended Retail Price) adjusts based on ordered quantity.
          </p>
        </div>
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="bg-gradient-to-r from-green-600/20 to-emerald-600/20 border border-green-500/50 rounded-lg p-4">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        <p className="text-slate-400 text-sm mb-1">Unit price at {qty} pcs:</p>
        ...
        <div className="mt-12 bg-slate-800/50 border border-slate-700/50 rounded-xl p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-slate-300">
            <div>
              ...
              <p className="text-sm">Higher price, only for small orders. Ideal for testing.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm">Wholesale price. Best deal for bulk orders.</p>
            </div>
          </div>
        </div>
      </div>
